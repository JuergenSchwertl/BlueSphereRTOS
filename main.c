...
static const pwm_channels pwm_channel_led_red = PWM_CHANNEL0;
static const pwms_bit_map pwm_bitmap_led_red = OS_HAL_PWM_0;
...
static const uint32_t pwm_frequency_led_blue = 20;
static uint32_t pwm_duty_led_blue = 500;
